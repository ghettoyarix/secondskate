    ...
    <div className="w-full flex justify-between">
      ...
      <div className="py-3">
        <label class="inline-flex relative items-center cursor-pointer">
          ...
          />
          <div
            class="w-11 h-6 bg-lightGray  peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white 
